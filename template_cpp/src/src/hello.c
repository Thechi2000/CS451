...
void hello() {
    printf(
        ...
        "while source files that end in .cpp will be compiled automatically "
        "with g++.\n"
        ...
        "Those who have both .c and .cpp files should ensure to have a "
        "compatible ABI when calling C functions from C++ "
